...
import { watchHistoryList } from '@/apis/common';
...
export default defineComponent({
    setup() {
        ...
        const handleClick = async (item: { episode_num: string; video_id: string; }) => {
        ...
        const onLoad = async (isFirst: boolean) => {
            try {
                ...
                const { data } = await watchHistoryList({
                    page,
                    page_size,
                });
